...
def load_from_site():
    ...
    url = base64.b64decode("aHR0cDovL2FwaS5tZWRpYWJheS50di92Mi9jaGFubmVscy9jaGFubmVscw").decode()
    headers = {"User-Agent": "Mozilla/5.0 (Windows NT 10.0; rv:86.0) Gecko/20100101 Firefox/86.0"}
