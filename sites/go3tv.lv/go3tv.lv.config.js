...
module.exports = {
  ...
  url({ channel, date }) {
    ...
    return `https://go3.lv/api/products/lives/programmes?liveId[]=${channel.site_id}&since=${since}&till=${till}&platform=BROWSER`
  },
  ...
  async channels() {
    try {
      const response = await axios.get('https://go3.lv/api/products/sections/v2/live_tv?platform=BROWSER')
