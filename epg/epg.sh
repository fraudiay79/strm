...
#npm run grab -- --site=tv.yettel.hu --output=../epg/epg-hu.xml --days=2 --maxConnections=10
...
#npm run grab -- --channels=../epg/mk.channels.xml --output=../epg/epg-mk.xml --days=2 --maxConnections=10
