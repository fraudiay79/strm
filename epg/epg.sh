...
#npm run grab -- --site=vivacom.bg --output=../epg/epg-bg.xml --days=2 --maxConnections=10
...
npm run grab -- --site=mujtvprogram.cz --output=../epg/epg-cz.xml --days=2 --maxConnections=10
...
npm run grab -- --site=maxtv.hrvatskitelekom.hr --output=../epg/epg-hr.xml --days=2 --maxConnections=10

# HU EPG

npm run grab -- --site=musor.tv --output=../epg/epg-hu.xml --days=2 --maxConnections=10
...
#npm run grab -- --site=maxtvgo.mk --output=../epg/epg-mk.xml --days=2 --maxConnections=10
...
#npm run grab -- --site=programtv.onet.pl --output=../epg/epg-pl.xml --days=2 --maxConnections=10
...
npm run grab -- --site=mts.rs --output=../epg/epg-rs.xml --days=2 --maxConnections=10
...
npm run grab -- --channels=../epg/sg.channels.xml --output=../epg/epg-sg.xml --days=2 --maxConnections=10

# TR EPG

npm run grab -- --channels=../epg/tr.channels.xml --output=../epg/epg-tr.xml --days=2 --maxConnections=10

# UK EPG

npm run grab -- --site=mytelly.co.uk --output=../epg/epg-uk.xml --days=2 --maxConnections=10
...
npm run grab -- --channels=../epg/xk.channels.xml --output=../epg/epg-xk.xml --days=2 --maxConnections=10
